...
const SaimaMarinaResidencePage = () => {
  ...
  const features = [
    { icon: Home, title: "Luxury Changing Rooms", description: "Premium changing facilities" },
    { icon: Home, title: "Open-Air Yoga Area", description: "Peaceful outdoor yoga space" },
    { icon: Home, title: "Premium Shower Facilities", description: "High-end shower amenities" },
    { icon: Home, title: "Professional Salon", description: "On-site professional salon services" },
    ...
    { icon: Car, title: "7 Floors Parking", description: "Extensive parking facilities" },
    ...
    { icon: Building, title: "5 Passenger Lifts", description: "Multiple elevators including cargo lift" },
    { icon: Home, title: "Indoor Gaming Zone", description: "Entertainment area with gaming facilities" },
    { icon: Home, title: "Open & Covered Dining Areas", description: "Flexible dining and entertainment spaces" },
    { icon: Home, title: "Luxury Sauna & Jacuzzi", description: "Premium wellness and relaxation facilities" }
  ];

  const unitTypes = [
    { 
      type: "1-Bedroom Marina View Apartment", 
      area: "950-1,150 sq ft", 
      price: "PKR 5.80 Cr", 
      bedrooms: 1, 
      bathrooms: 1,
      tokens: 1000,
      tokenPrice: "PKR 58,000"
    },
    { 
      type: "2-Bedroom Sea View Apartment", 
      area: "1,500-1,900 sq ft", 
      price: "PKR 9.50-12.50 Cr", 
      bedrooms: 2, 
      bathrooms: 2,
      tokens: 1000,
      tokenPrice: "PKR 95,000-125,000"
    },
    { 
      type: "3-Bedroom Premium Apartment", 
      area: "2,100-2,700 sq ft", 
      price: "PKR 14.50-18.00 Cr", 
      bedrooms: 3, 
      bathrooms: 3,
      tokens: 1000,
      tokenPrice: "PKR 145,000-180,000"
    },
    { 
      type: "4-Bedroom Elite Apartment", 
      area: "2,900-3,500 sq ft", 
      price: "PKR 19.50-22.50 Cr", 
      bedrooms: 4, 
      bathrooms: 4,
      tokens: 1000,
      tokenPrice: "PKR 195,000-225,000"
    },
    { 
      type: "Marina Penthouse", 
      area: "4,200-5,200 sq ft", 
      price: "PKR 30.00+ Cr", 
      bedrooms: 4, 
      bathrooms: 5,
      tokens: 1000,
      tokenPrice: "PKR 300,000+"
    }
  ];

  const investmentDetails = {
    totalValue: "PKR 5.80 - 22.50 Cr",
    marketValue: "PKR 7.33 - 28.46 Cr", 
    appreciation: "26.4%",
    expectedROI: "14-18%",
    minInvestment: "PKR 58,000 - 225,000",
    totalTokens: 1000,
    availableTokens: 1000,
    pricePerToken: "PKR 58,000 - 225,000",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">Saima Marina Residence</h1>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  ...
                  <div className="text-white text-xl font-bold">PKR 5.80 - 22.50 Cr</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  <div className="text-white/60 text-sm">Expected ROI</div>
                  <div className="text-white text-xl font-bold">14-18%</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
              ...
              <p className="text-white/80 leading-relaxed">
                Saima Marina Residence offers an unparalleled living experience across Ground + 40 floors at HMR Waterfront. Awaken to breathtaking sea views from your modern residence, where every detail exudes sophistication and marina lifestyle.
              </p>
            ...
            {activeTab === 'overview' && (
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                  <h3 className="text-2xl font-bold text-white mb-4">About Saima Marina Residence</h3>
                  <p className="text-[#dee0e5] leading-relaxed mb-6">
                    Saima Marina Residence represents the epitome of marina lifestyle living at HMR Waterfront. This 40-storey residential tower offers residents a sophisticated coastal living experience with world-class amenities and stunning sea views.
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-[#315dca] mr-3" />
                      <span className="text-white">Marina lifestyle experience</span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-[#315dca] mr-3" />
                      <span className="text-white">Breathtaking sea views</span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-[#315dca] mr-3" />
                    ...
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-[#315dca] mr-3" />
                      <span className="text-white">Sophisticated design</span>
                    </div>
                  </div>
                </div>
...
export default SaimaMarinaResidencePage;
