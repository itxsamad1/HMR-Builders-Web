...
const HSResidencePage = () => {
  ...
  const propertyImages = [
    "/projects/hs-residence/main.jpg"
  ];

  const features = [
    { icon: Building, title: "Architectural Design By Nicken Sekkei", description: "World-renowned Japanese architectural firm" },
    { icon: Home, title: "3 & 4 Bedroom Apartments with Plunge Pools", description: "Private plunge pools in select units" },
    { icon: Waves, title: "Multiple Infinity Pools", description: "Stunning infinity pools with sea views" },
    { icon: Building, title: "Creative Workspaces", description: "Dedicated co-working and creative spaces" },
    { icon: Car, title: "Multi-Level Car Parking", description: "Extensive parking facilities" },
    { icon: Dumbbell, title: "Premium Fitness Center", description: "State-of-the-art gym with modern equipment" },
    { icon: Building, title: "High Speed Elevators", description: "Fast and reliable elevator systems" },
    { icon: Home, title: "Executive Snooker Lounge", description: "Premium entertainment and recreation area" },
    { icon: Building, title: "Double Height Retail Shops", description: "Premium ground floor retail spaces" },
    { icon: Building, title: "Double Height Grand Lobby", description: "Imposing entrance with luxury finishes" },
    { icon: Home, title: "Kids Play & Pool Area", description: "Dedicated children's recreation facilities" },
    { icon: Building, title: "Social Areas with 8 Lifts", description: "Multiple elevators including cargo lift" },
    { icon: Home, title: "Luxury Spa & Sauna", description: "Premium wellness and relaxation facilities" }
  ];

  const unitTypes = [
    { 
      type: "1-Bedroom Apartment", 
      area: "900-1,100 sq ft", 
      price: "PKR 6.50 Cr", 
      bedrooms: 1, 
      bathrooms: 1,
      tokens: 1000,
      tokenPrice: "PKR 65,000"
    },
    { 
      type: "2-Bedroom Apartment", 
      area: "1,400-1,800 sq ft", 
      price: "PKR 10.50-13.50 Cr", 
      bedrooms: 2, 
      bathrooms: 2,
      tokens: 1000,
      tokenPrice: "PKR 105,000-135,000"
    },
    { 
      type: "3-Bedroom Apartment with Plunge Pool", 
      area: "2,000-2,500 sq ft", 
      price: "PKR 16.00-19.50 Cr", 
      bedrooms: 3, 
      bathrooms: 3,
      tokens: 1000,
      tokenPrice: "PKR 160,000-195,000"
    },
    { 
      type: "4-Bedroom Apartment with Plunge Pool", 
      area: "2,800-3,400 sq ft", 
      price: "PKR 22.00-24.50 Cr", 
      bedrooms: 4, 
      bathrooms: 4,
      tokens: 1000,
      tokenPrice: "PKR 220,000-245,000"
    },
    { 
      type: "Japanese-Style Penthouse", 
  ...
  const investmentDetails = {
    totalValue: "PKR 6.50 - 24.50 Cr",
    marketValue: "PKR 8.03 - 30.23 Cr", 
    appreciation: "23.5%",
    expectedROI: "15-19%",
    minInvestment: "PKR 65,000 - 245,000",
    totalTokens: 1000,
    availableTokens: 1000,
    pricePerToken: "PKR 65,000 - 245,000",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">H&S Residence</h1>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  ...
                  <div className="text-white text-xl font-bold">PKR 6.50 - 24.50 Cr</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  <div className="text-white/60 text-sm">Expected ROI</div>
                  <div className="text-white text-xl font-bold">15-19%</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  <div className="text-white/60 text-sm">Floors</div>
                  <div className="text-white text-xl font-bold">Ground + 39</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
              ...
              <p className="text-white/80 leading-relaxed">
                H&S Residence is a coastal haven standing 39 storeys tall along Karachi's vibrant shoreline. Inspired by the Japanese Nami design philosophy, our architecture reflects the fluidity of ocean waves, creating a unique living experience.
              </p>
            ...
            {activeTab === 'overview' && (
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                  <h3 className="text-2xl font-bold text-white mb-4">About H&S Residence</h3>
                  <p className="text-[#dee0e5] leading-relaxed mb-6">
                    H&S Residence represents a unique fusion of Japanese design philosophy and coastal living. Inspired by the Nami (wave) design concept, this 39-storey tower creates a harmonious connection between architecture and nature.
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-[#315dca] mr-3" />
                      <span className="text-white">Japanese Nami design philosophy</span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-[#315dca] mr-3" />
                      <span className="text-white">Private plunge pools</span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-[#315dca] mr-3" />
                      <span className="text-white">Coastal living experience</span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-[#315dca] mr-3" />
...
export default HSResidencePage;
