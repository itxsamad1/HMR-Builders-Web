...
const AnimatedLoadingSkeleton = () => {
    ...
    return (
        <motion.div
            className="w-full max-w-4xl mx-auto p-6 bg-[#0a0a0a] rounded-xl shadow-2xl border border-[#333]"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[...Array(config.numCards)].map((_, i) => (
                        <motion.div
                            ...
                            className="bg-[#1a1a1a] rounded-lg shadow-lg border border-[#333] p-4"
                        >
                            {/* Card placeholders */}
                            <motion.div
                                className="h-32 bg-[#333] rounded-md mb-3"
                                animate={{
                                    background: ["#333", "#444", "#333"],
                                }}
                                transition={{ duration: 1.5, repeat: Infinity }}
                            />
                            <motion.div
                                className="h-3 w-3/4 bg-[#333] rounded mb-2"
                                animate={{
                                    background: ["#333", "#444", "#333"],
                                }}
                                transition={{ duration: 1.5, repeat: Infinity }}
                            />
                            <motion.div
                                className="h-3 w-1/2 bg-[#333] rounded"
                                animate={{
                                    background: ["#333", "#444", "#333"],
                                }}
                                transition={{ duration: 1.5, repeat: Infinity }}
